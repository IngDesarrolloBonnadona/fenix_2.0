...
import ReasonCancellationCaseContent from "@/components/configuration/reason_cancellation_case/ReasonCancellationCaseContent";
...
const ReasonCancellationCaseParametrizationPage = () => {
  ...
  return (
    <div className="homepage-reason-cancellation-case-content">
...
export default ReasonCancellationCaseParametrizationPage;
