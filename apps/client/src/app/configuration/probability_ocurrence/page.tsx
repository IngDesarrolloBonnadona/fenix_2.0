...
import ProbabilityOcurrenceContent from "@/components/configuration/probability_ocurrence/ProbabilityOcurrenceContent";
...
const ProbabilityOcurrencePage = () => {
  ...
  return (
    <div className="homepage-probability-ocurrence">
...
export default ProbabilityOcurrencePage;
