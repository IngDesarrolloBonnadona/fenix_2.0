...
import SelectInstrumentContent from "@/components/select_instrument/SelectInstrumentContent";
...
const SelectInstrumentPage = () => {
  ...
  return (
    <div className="homepage-select-instrument">
