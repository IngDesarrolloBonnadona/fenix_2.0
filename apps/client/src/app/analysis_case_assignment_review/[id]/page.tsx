...
import AnalysisCaseAssignmentReviewContent from "@/components/analysis_case_assignment_review/AnalysisCaseAssignmentReviewContent";
...
const AnalysisCaseAssignmentReviewPage = () => {
      ...
      {!idNumberUserSessionState || status === "unauthenticated" ? (
        ...
        <CustomDashboardLayout
          customLayoutContent={
            ...
            >
              <AnalysisCaseAssignmentReviewContent />
            </div>
          }
        />
      )}
...
export default AnalysisCaseAssignmentReviewPage;
