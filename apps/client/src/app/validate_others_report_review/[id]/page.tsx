...
import ValidateOtherReportReviewContent from "@/components/validate_others_report_review/ValidateOtherReportReviewContent";
...
const ValidateOrhersReportReviewPage = () => {
  ...
  return (
    <div className={"homepage-validate-others-review"}>
      {!idNumberUserSessionState || status === "unauthenticated" ? (
        ...
        <CustomDashboardLayout
          customLayoutContent={
            ...
            >
              <ValidateOtherReportReviewContent />
            </div>
          }
        />
      )}
...
export default ValidateOrhersReportReviewPage;
