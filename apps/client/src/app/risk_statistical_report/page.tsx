...
import RiskStatisticalReportContent from "@/components/risk_statistical_report/RiskStatisticalReport";

const RiskStatisticalReportPage = () => {
  ...
  return (
    <div className="homepage-risk-statistical-report">
...
export default RiskStatisticalReportPage;
