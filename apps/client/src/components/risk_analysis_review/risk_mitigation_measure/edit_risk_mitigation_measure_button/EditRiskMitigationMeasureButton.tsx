...
import EditRiskMitigationMeasureFormData from "../edit_risk_mitigation_measure_form_data/EditRiskMitigationMeasureFormData";

import { EditOutlined } from "@ant-design/icons";

import { useUpdateRiskMitigationMeasureMutation } from "@/redux/apis/risk_mitigation_measure/riskMitigationMeasure";

const EditRiskMitigationMeasureButtonComponent: React.FC<{
  onRefetch: () => void;
  dataRecord: RiskMitigationMeasure;
  ...
  const [
    ...
    { isLoading: updatedRiskMitigationMeasureLoading },
  ] = useUpdateRiskMitigationMeasureMutation();

  useEffect(() => {
    if (isModalOpen && !nameLocalState) {
      setNameLocalState(dataRecord.ris_m_name);
    }
  ...
  const hasChanges = () => {
    const initialData = {
      dataName: dataRecord.ris_m_name,
    };
  ...
  const handleClickSubmit = async () => {
    try {
      const response: any = await updateRiskMitigationMeasure({
        id: dataRecord.id,
        updateRiskMitigationMeasure: {
          ris_m_name: nameLocalState,
        },
      });
  ...
  return (
    <>
      ...
      <CustomModalNoContent
        key={"custom-modal-edit-mitigation-measure"}
        ...
        contentCustomModal={
          <EditRiskMitigationMeasureFormData
            ...
            updatedRiskMitigationMeasureLoadingFormdata={
              updatedRiskMitigationMeasureLoading
            }
...
export default EditRiskMitigationMeasureButtonComponent;
