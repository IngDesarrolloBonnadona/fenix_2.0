...
import { useCreateFailedMeasureMutation } from "@/redux/apis/failed_measure/failedMeasureApi";

const CreateFailedMeasureButtonComponent: React.FC<{
  onNewRegister: () => void;
}> = ({ onNewRegister }) => {
  ...
  const [createFailedMeasure, { isLoading: createdFailedMeasureDataLoading }] =
  ...
  const handleClickSubmit = async () => {
    try {
      const response: any = await createFailedMeasure({
  ...
  return (
    <>
      ...
      <CustomModalNoContent
        key={"custom-modal-create-failed-measure"}
        ...
        contentCustomModal={
          <>
            <Form
              form={form}
              id="create-failed-measure-form"
              name="create-failed-measure-form"
              className="create-failed-measure-form"
            ...
            >
              ...
              <Form.Item
                label="Descripción:"
                name="failed-measure-description"
              ...
              >
                <CustomButton
                  classNameCustomButton="clean-failed-measure-button"
                  idCustomButton="clean-failed-measure-button"
                ...
                />
                <CustomButton
                  classNameCustomButton="create-failed-measure-button"
                  idCustomButton="create-failed-measure-button"
                  titleCustomButton="Crear"
                  typeCustomButton="primary"
                  htmlTypeCustomButton="submit"
                  iconCustomButton={
                    !createdFailedMeasureDataLoading ? (
                      <SaveOutlined />
                    ) : (
                      <LoadingOutlined />
                    )
                  ...
                  disabledCustomButton={
                    !createdFailedMeasureDataLoading ? false : true
                  }
                  onClickCustomButton={() => ({})}
                  styleCustomButton={{
                    color: "#ffffff",
...
export default CreateFailedMeasureButtonComponent;
