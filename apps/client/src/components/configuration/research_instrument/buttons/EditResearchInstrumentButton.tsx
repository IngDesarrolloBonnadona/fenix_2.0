        ...
        contentCustomModal={
          <>
            <Form
              ...
              initialValues={{
                "name-research-instrument": dataRecord.inst_r_name,
                "description-research-instrument":
                  dataRecord.inst_r_description,
              }}
              autoComplete="off"
              layout="vertical"
              style={{ width: "100%" }}
            ...
            >
              ...
              <Form.Item
                label="Descripción:"
                name="description-research-instrument"
                style={{ marginBottom: "16px" }}
              >
                <TextArea
