...
import { useUpdateInfluencingFactorMutation } from "@/redux/apis/influencing_factor/influencingFactorApi";

const EditInfluencingFactorButtonComponent: React.FC<{
  ...
  const [
    ...
    { isLoading: updateInfluencingFactorDataLoading },
  ...
  const hasChanges = () => {
    const initialData = {
      dataName: dataRecord.inf_f_name,
      dataDescription: dataRecord.inf_f_description,
    };
  ...
  return (
    <>
      ...
      <CustomModalNoContent
        key={"custom-modal-edit-influencing-factor"}
        ...
        contentCustomModal={
          <>
            <Form
              ...
              name="edit-influencing-factor-form"
              className="edit-influencing-factor-form"
              initialValues={{
                "name-influencing-factor": dataRecord.inf_f_name,
                "description-influencing-factor": dataRecord.inf_f_description,
              }}
              autoComplete="off"
              layout="vertical"
              style={{ width: "100%" }}
            ...
            >
              ...
              <Form.Item
                label="Descripción:"
                name="description-influencing-factor"
                style={{ marginBottom: "16px" }}
              >
                <TextArea
              ...
              >
                <CustomButton
                  classNameCustomButton="edit-influencing-factor-button"
                  idCustomButton="edit-influencing-factor-button"
                  titleCustomButton="Actualizar"
                  typeCustomButton="primary"
                  htmlTypeCustomButton="submit"
                  iconCustomButton={
                    !updateInfluencingFactorDataLoading ? (
                      <BiEdit />
                    ) : (
                      <LoadingOutlined />
                    )
                  ...
                  disabledCustomButton={
                    hasChanges() && !updateInfluencingFactorDataLoading
                      ? false
                      : true
                  }
                  onClickCustomButton={() => ({})}
...
export default EditInfluencingFactorButtonComponent;
