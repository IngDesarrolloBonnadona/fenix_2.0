...
const CreateReasonCancellationCaseButtonComponent: React.FC<{
  onNewRegister: () => void;
}> = ({ onNewRegister }) => {
  ...
  const [
    ...
    { isLoading: createdReasonCancellationCaseDataLoading },
  ] = useCreateReasonCancellationCaseMutation({
    fixedCacheKey: "createReasonCancellationCase",
  });

  const {
    data: allReasonCancellationCasesData,
    isFetching: allReasonCancellationCasesFetching,
    isLoading: allReasonCancellationCasesLoading,
    error: allReasonCancellationCasesError,
  ...
  const handleSearch = (value: string) => {
    if (value) {
      const filteredOptions =
        allReasonCancellationCasesData
          ?.filter((types) =>
            types.cac_r_cause.toUpperCase().includes(value.toUpperCase())
          )
          .map((type) => ({
            value: type.cac_r_cause,
          })) || [];
  ...
  const handleClickSubmit = async () => {
    try {
      const response: any = await createReasonCancellationCase({
  ...
  return (
    <>
      ...
      <CustomModalNoContent
        key={"custom-modal-create-cancellation-return-case"}
        ...
        contentCustomModal={
          <>
            <Form
              form={form}
              id="create-reason-cancellation-case-form"
              name="create-reason-cancellation-case-form"
              className="create-reason-cancellation-case-form"
            ...
            >
              <Form.Item
                label="Nombre:"
                name="reason-cancellation-case-name"
                style={{
                  marginBottom: "16px",
                }}
                normalize={(value) => {
              ...
              >
                <AutoComplete
                  id="name-reason-cancellation-case"
                  options={options}
              ...
              >
                <CustomButton
                  classNameCustomButton="clean-reason-cancellation-case-button"
                  idCustomButton="clean-reason-cancellation-case-button"
                ...
                />
                <CustomButton
                  classNameCustomButton="create-reason-cancellation-case-button"
                  idCustomButton="create-reason-cancellation-case-button"
                  titleCustomButton="Crear"
                  typeCustomButton="primary"
                  htmlTypeCustomButton="submit"
                  iconCustomButton={
                    !createdReasonCancellationCaseDataLoading ? (
                      <SaveOutlined />
                    ) : (
                      <LoadingOutlined />
                    )
                  ...
                  disabledCustomButton={
                    !createdReasonCancellationCaseDataLoading ? false : true
                  }
                  onClickCustomButton={() => ({})}
                  styleCustomButton={{
                    color: "#ffffff",
...
export default CreateReasonCancellationCaseButtonComponent;
