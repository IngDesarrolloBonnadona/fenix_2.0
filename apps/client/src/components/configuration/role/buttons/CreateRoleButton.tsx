  ...
  const handleSearch = (value: string) => {
    if (value) {
      const filteredOptions =
        allRolesData
          ?.filter((types) =>
            types.role_name.toUpperCase().includes(value.toUpperCase())
          )
          .map((type) => ({
            ...
            >
              ...
              >
                <AutoComplete
                  ...
                  filterOption={false}
                >
                  <Input id="input-name-role" type="text" autoComplete="off" />
                </AutoComplete>
              </Form.Item>
              ...
              >
                <CustomButton
                  classNameCustomButton="clean-role-button"
                  idCustomButton="clean-role-button"
                ...
                />
                <CustomButton
                  classNameCustomButton="create-role-button"
                  idCustomButton="create-role-button"
                  titleCustomButton="Crear"
                  typeCustomButton="primary"
                  htmlTypeCustomButton="submit"
                  iconCustomButton={
                    !createdRoleDataLoading ? (
                      <SaveOutlined />
                    ) : (
                      <LoadingOutlined />
                    )
                  }
                  disabledCustomButton={!createdRoleDataLoading ? false : true}
                  onClickCustomButton={() => ({})}
                  styleCustomButton={{
                    color: "#ffffff",
                    borderRadius: "16px",
...
export default CreateRoleButtonComponent;
