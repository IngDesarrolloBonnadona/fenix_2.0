...
const EditDamageTypeButtonComponent: React.FC<{
  ...
  useEffect(() => {
    if (isModalOpenLocalState) {
      setNameLocalState(dataRecord.dam_t_name);
      setDescriptionLocalState(dataRecord.dam_t_description);
    }
  ...
  const handleClickSubmit = async () => {
    try {
      const response: any = await updateDamageType({
        id: dataRecord.id,
        updateDamageType: {
          dam_t_name: nameLocalState,
          dam_t_description: descriptionLocalState,
        },
      });
        ...
        contentCustomModal={
          <>
            <Form
              ...
              initialValues={{
                "name-damage-type": dataRecord.dam_t_name,
                "description-damage-type": dataRecord.dam_t_description,
              }}
              autoComplete="off"
              layout="vertical"
              style={{ width: "100%" }}
