...
const IndicationsUnsafeCareContent = () => {
  ...
  const [showDescriptionOthersLocalState, setShowDescriptionOthersLocalState] =
    useState(false);
  const [
    descriptionIndicationsUnsafeCareLocalState,
    setDescriptionIditionsUnsafeCareLocalState,
  ] = useState("");
  ...
  const idOfCaseTypeState = useAppSelector(
    (state) => state.changeOfCaseType.idOfCaseTypeIndicationsUnsafeCare
  );
    ...
    try {
      ...
      const response: any = await createCaseReportOriginal({
        ...
        newReportOriginal: {
          ...
          ori_cr_description: descriptionIndicationsUnsafeCareLocalState,
              ...
              <Col xs={24} sm={25} md={12} lg={24}>
                ...
                >
                  <TextArea
                    ...
                    value={descriptionIndicationsUnsafeCareLocalState}
